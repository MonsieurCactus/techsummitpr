// AtlasPR is a javascript Class defined with klass.js
var AtlasPR = klass(function (options) {
  ...
  //hack to make dropbox pages work
  this.geotiles_path = "http://dl.dropboxusercontent.com/u/17949100/OGP/geotiles/PATHGEN.json";
...
.methods({
  ...
  draw: function () {
	...
	console.log("abcde");
	console.log(self.geotiles_path.replace("PATHGEN", self.tiles.sort().join("+")));
